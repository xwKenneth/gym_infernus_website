        ...
        switch ($_GET['action']) {
            ...
            case 'createRow':
                ...
                if (
                    ...
                    !$valoracion->setFechaVenta($_POST['fechaValoracion']) 
                ) {
                    // Error de validación
            ...
            case 'updateRow':
                $_POST = Validator::validateForm($_POST);
                if (
                    !$valoracion->setFechaVenta($_POST['fechaVenta']) or
     
                    !$valoracion->setCliente($_POST['clienteVenta']) or
            ...
            case 'deleteRow':
                if (
                    ...
                    $result['fileStatus'] = Validator::deleteFile($valoracion::RUTA_IMAGEN, $valoracion->getFilename());
                } else {
